    ...
    <div>
      ...
      <div className={styles.MainMenuMeetNews}>
        ...
        <div className={styles.MainMenuAllNews}>
          <div className={styles.MainMenuBlueNews}>
          ...
          <div className={styles.MainMenuBrownNews}>
            <p className={styles.MainMenuNewsFont}>Скидки</p>
          </div>
          <div className={styles.MainMenuGreenNews}>
            <p className={styles.MainMenuNewsFont}>Жопа</p>
          </div>
          <div className={styles.MainMenuPinkNews}>
            <p className={styles.MainMenuNewsFont}>
              Star
              <br />
              Gems
      ...
      <div className={styles.MainMenuBtnCont}>
        <div>
          <button className={styles.MainMenuBtnBlue}>
            Карточка сотрудника
          </button>
